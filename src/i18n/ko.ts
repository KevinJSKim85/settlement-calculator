export const ko = {
  ...
  formula: {
    label: '계산식',
    values: '값',
    balance: '발란스 = 발란스 A + 발란스 B',
    balanceA: '발란스 A = 바잉 A - 리턴 A',
    balanceB: '발란스 B = 발란스 - 발란스 A',
    buyingA: '바잉 A = 전체 바잉 × A 비율',
    buyingB: '바잉 B = 전체 바잉 - 바잉 A',
    returningA: '리턴 A = 전체 리턴 × A 비율',
    returningB: '리턴 B = 전체 리턴 - 리턴 A',
    returningADisplay: '리턴 A 표시값 = -(전체 리턴 × A 비율)',
    returningBDisplay: '리턴 B 표시값 = -(전체 리턴 - 리턴 A)',
    rollingFee: '롤피 = 롤링 금액 × 요율',
    rollingTotal: '롤피 합계 = 모든 롤피의 합',
    ...
    cashFlow: 'Cash Flow = 항목별 금액 크기 비교',
    directInput: '직접 입력값',
  },
  settings: {
    title: '설정',
